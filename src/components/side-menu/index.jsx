            ...
            <div className="side-menu-container">
                ...
                <div className="side-menu-items">
                    ...
                    <div className="polar-bear-menu-content">
                        <NavLink exact to="/polar-bear" className = "polar-bear" onClick={()=>{handleClick(0)}} >
                    ...
                    <div className="forest-elephant-menu-content">
                        <NavLink exact to="/forest-elephant" className = "forest-elephant" onClick={()=>{handleClick(1)}}>
                    ...
                    <div className="whooping-crane-menu-content">
                        <NavLink exact to="/whooping-crane" className = "whooping-crane" onClick={()=>{handleClick(2)}}>
                    ...
                    <div className="sea-turtle-menu-content">
                        <NavLink exact to="/sea-turtle" className = "sea-turtle" onClick={()=>{handleClick(3)}}>
                    ...
                    <div className="orangutan-menu-content">
                        <NavLink exact to="/orangutan" className = "orangutan" onClick={()=>{handleClick(4)}}>
